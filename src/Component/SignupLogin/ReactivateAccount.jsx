    ...
    <>
      ...
      {loading ? (
        ...
        <div className='bg-white p-8 mx-10 rounded-lg shadow-lg text-center'>
          <h1 className='text-2xl font-bold text-orange-500'>Reactivate Account Link Sent</h1>
          <p className='text-gray-600 mt-4'>
            A Reactivate Account link has been sent to your email address. Please check your inbox and follow the instructions in the email to reactivate your account.
          </p>
        </div>
      </div>
