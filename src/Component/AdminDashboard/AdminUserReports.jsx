...
const AdminUserReports = () => {
  ...
  const fetchReportedIssues = async () => {
    try {
      const response = await Axios.get("/getUsersReports");
  ...
  const columns = [
    {
      ...
      {
        title: "Host/Guest ID",
        dataIndex: "hostorguestId",
        key: "hostorguestId",
      },
      {
        title: "Host/Guest Name",
        dataIndex: "hostorguestName",
        key: "hostorguestName",
      },
      {
        title: "Host/Guest Email",
        dataIndex: "hostorguestEmail",
        key: "hostorguestEmail",
      },
      {
        title: "Host/Guest Status",
        dataIndex: "hostorguestStatus",
        key: "hostorguestStatus",
      },
      {
        title: "Reporter Name",
      ...
      {
        title: "Extra Reason for Reporting",
