    ...
    <div className="container max-w-2xl mx-auto p-4">
      ...
      {succesfull ?
        ...
        <>
          {loading ?
            ...
            <>
              ...
              <GoBackButton />
              <SettingsNavigation title="Complete Your ID Verification" text="Account Verification" />
              <p className=" text-gray-600">
                To ensure the safety and security of our community, we require you to verify your identity.
                Please provide a clear photo of your government-issued ID and a selfie. This helps us confirm your
                identity and maintain the integrity of our platform.
              </p>

              <h2 className="mt-4 font-semibold">1. Select the type of ID you will upload.</h2>
              <p className=" text-xs text-gray-600">Before you begin, select the type of ID you will upload from the options provided</p>
              <Select
        ...
        /> */}
              ...
              <h2 className="mt-4 font-semibold">2. Select a clear picture of your your ID.</h2>
              <p className=" text-xs text-gray-600">Place your ID on a flat, well-lit surface without glare.
                Ensure the entire ID is visible in the frame and focus. All text and photos should be clear and legible.
              </p>
              ...
              <h2 className="mt-4 font-semibold">3. Take your selfie.</h2>
              <p className=" text-xs text-gray-600">Choose a well-lit area where your face is visible without shadows.
                Position your camera at eye level and look directly into the camera without any headgear or glasses that could obscure your face.
              </p>
              <div className="mt-4">
                ...
                <div className="my-4">
                  ...
                  <p className=" text-xs text-gray-600">
                    Review each image carefully to ensure clarity and accuracy. If any photos are unclear or parts of your ID are not visible, please retake the photos.
                  </p>
                </div>
                {submittedImages && (
