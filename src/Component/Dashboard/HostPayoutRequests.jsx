...
import PayoutBankDetails from '../Settings/PayoutBankDetails';
import { useStateContext } from "../../ContextProvider/ContextProvider";
import axios from '../../Axios'
import { message, Popconfirm, Tag } from 'antd';
import { LoadingOutlined } from '@ant-design/icons';
import { styles } from '../ChatBot/Style'
import AccountNumberForm from "../Settings/ProfileCardSettings/AccountNumberForm"; 


export default function HostPayoutRequests() {
    ...
    const detailsArray = [
        {
            ...
            value: "Add Bank Details for Payout",
            action: "Add",
            link: "/edit-name",
        },
        ...accountDetails,
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        {/* <h2 className="text-lg font-semibold mb-2">Submit Payout Request</h2> */}
        <div>
            {loading ?
                <>
